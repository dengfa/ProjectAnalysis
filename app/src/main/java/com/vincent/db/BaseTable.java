...
public abstract class BaseTable<T> implements BaseColumns {
    ...
    public BaseTable(String tableName, DataBaseHelper sqlHelper) {
    ...
    public SQLiteDatabase getDatabase() {
        ...
        DataBaseHelper helper = DataBaseManager.getDataBaseManager().getDefaultDB();
        if (helper == null)
            return null;
    ...
    //		Uri uri = Uri.parse(
    //				SCHEMA + "com.hyena.providers.update_" + tableName + "/" + tableName);
    //		return uri;
    //	}
    ...
    //		DataBaseManager.getDataBaseManager().notifyDataBaseChange(uri);

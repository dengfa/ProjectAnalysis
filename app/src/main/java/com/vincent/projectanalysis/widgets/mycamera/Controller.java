...
import com.vincent.projectanalysis.camera.ExtraProperties;
...
public abstract class Controller implements CameraPreview.SurfaceCallback {
    ...
    Controller(CameraView.CameraCallbacks callback) {

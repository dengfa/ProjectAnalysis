...
public class MainFragment extends BaseUIFragment<BaseUIFragmentHelper> implements AdapterView.OnItemClickListener {
    ...
    private String[] tabs = {
            "沉浸式适配", "HomeworkResultDialog", "HomeworkResultDialog", "ListFragment","TestSubFragment"};
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        switch (position) {
            ...
            case 2:
                ...
                break;
            case 3:
                showFragment(TestListFragment.class, null);
                break;
            case 4:
                showFragment(TestSubFragment.class, null);
                break;
        }
    }
}

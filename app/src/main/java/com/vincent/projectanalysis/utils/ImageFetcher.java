...
public class ImageFetcher {
    ...
    private void initImageFetcher() {
        File appRoot = App.getAppContext().getCacheDir();
        ...
        if (mMemoryCache == null) {
            mMemoryCache = DefaultConfigurationFactory.createMemoryCache(App.getAppContext(), 0);
        }
        ...
        ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(App.getAppContext())
    ...
    public Bitmap getBitmapInCache(String uri) {
        if (mMemoryCache != null) {
            final DisplayMetrics displayMetrics = App.getAppContext().getResources().getDisplayMetrics();
